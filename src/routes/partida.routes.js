...
import { getRepeticionPartida } from '../controllers/partida.controller.js';

const partidaRouter = Router();

partidaRouter.post('/id_partida', getPartida);
...
partidaRouter.post('/id_partida/repeticion', getRepeticionPartida);
